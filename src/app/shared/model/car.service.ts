...
export class CarService {
  ...
  private cars = [
    ...
    //   featureContent: [
    //     {
    //       featureImagePath : this.carPath+'lexus-es/features/refined-luxurious-drive.jpg',
    ...
    //     },{
    //       featureImagePath : this.carPath+'lexus-es/features/ultra-low-emissions.jpg',
    ...
    //     },{
    //       featureImagePath : this.carPath+'lexus-es/features/fuel-consumption.jpg',
    ...
    //     },{
    //       featureImagePath : this.carPath+'lexus-es/features/exceptional-comfort.jpg',
    ...
    //     },{
    //       featureImagePath : this.carPath+'lexus-es/features/lexus-safety-system.jpg',
    //       featureHeading: 'Lexus Safety System +',
    ...
    //     },{
    //       featureImagePath : this.carPath+'lexus-es/features/15-speaker-mark-levinson-audio.jpg',
    ...
    //     },{
    //       featureImagePath : this.carPath+'lexus-es/features/heated-and-ventilated-seats.jpg',
    ...
    //     },{
    //       featureImagePath : this.carPath+'lexus-es/features/warranty.jpg',
    //       featureHeading: 'Warranty',
    //       featureCopy: 'Refer to your Lexus Dealership.',
    //     }
    //   ],
    // },{
      ...
      featureContent: [
        {
          featureImagePath : this.carPath+'lexus-gs/features/refined-luxurious-drive.jpg',
          featureHeading: 'Refined Luxurious Drive (ES 300h Limited)',
          featureCopy: 'With a beautiful trim, polished to a high sheen, ambient illumination on the interior compliments the sleek lines of the exterior.',
        },{
          featureImagePath : this.carPath+'lexus-gs/features/ultra-low-emissions.jpg',
          featureHeading: 'Ultralow Emissions',
          featureCopy: 'The ES 300h and ES 300h Limited deliver superb engine power with lower carbon emissions at 130 g/km.',
        },{
          featureImagePath : this.carPath+'lexus-gs/features/fuel-consumption.jpg',
          featureHeading: 'Rated at 5.5L/100kms Fuel Consumption ',
          featureCopy: 'Excellent Fuel Economy and reduced emissions, utilising the hybrid electric technology.',
        },{
          featureImagePath : this.carPath+'lexus-gs/features/exceptional-comfort.jpg',
          featureHeading: 'Exceptional Comfort',
          featureCopy: 'The ES is designed with your comfort in mind, from the Shimomoku ornamentation to the beautifully crafted leather seats to the technology available to get you to your destination effortlessly.',
        },{
          featureImagePath : this.carPath+'lexus-gs/features/lexus-safety-system.jpg',
          featureHeading: 'Lexus Safety System +',
          featureCopy: 'The package includes advanced driver assistance functions such as the Pre-Crash Safety system with Autonomous Emergency Braking System, Dynamic Radar Cruise Control, Lane-Departure Alert and Automatic High Beam. The ES has all you need and more for a safe drive.',
        },{
          featureImagePath : this.carPath+'lexus-gs/features/15-speaker-mark-levinson-audio.jpg',
          featureHeading: '15 Speaker Mark Levinson Audio (ES 300h Limited)',
          featureCopy: '15 Speaker Mark Levinson Premium Audio system surrounding the interior of the car creates an authentic sound experience combing both mid and high frequencies, fuelling a rich full sound in every seat.',
        },{
          featureImagePath : this.carPath+'lexus-gs/features/heated-and-ventilated-seats.jpg',
          featureHeading: 'Heated and Ventilated Seats',
          featureCopy: 'With seat temperature control (front and rear - temperature controls for front and rear only in Limited), easy access systems and lumbar support, find comfort in every drive. And have peace of mind with the Whiplash Injury Lessening (WIL) Concept Front Seat Design.',
        },{
          featureImagePath : this.carPath+'lexus-gs/features/warranty.jpg',
          featureHeading: 'Warranty',
          featureCopy: 'Refer to your Lexus Dealership.',
        }
      ],
      ...
      featureContent: [
        {
          featureImagePath : this.carPath+'lexus-nx/features/striking-bold-design.jpg',
          ...
          featureImagePath : this.carPath+'lexus-nx/features/electric-hybrid-or-turbo-petrol.jpg',
          ...
          featureImagePath : this.carPath+'lexus-nx/features/modern-interior-design.jpg',
          ...
          featureImagePath : this.carPath+'lexus-nx/features/wireless-mobile-phone-charging.jpg',
          ...
          featureImagePath : this.carPath+'lexus-nx/features/360-degree-view-camera.jpg',
          ...
          featureImagePath : this.carPath+'lexus-nx/features/full-navigation-system.jpg',
          ...
          featureImagePath : this.carPath+'lexus-nx/features/power-back-door.jpg',
          ...
          featureImagePath : this.carPath+'lexus-nx/features/warranty.jpg',
          featureHeading: 'Warranty',
          featureCopy: 'Refer to your Lexus Dealership.',
        }
      ],
      ...
      featureContent: [
        {
          featureImagePath : this.carPath+'lexus-rx/features/striking-and-bold-design.jpg',
          featureHeading: 'Striking and Bold Design',
          featureCopy: 'The RX exudes untamed elegance. Get ready to blaze new trails with confidence-inspiring looks.',
        },{
          featureImagePath : this.carPath+'lexus-rx/features/8-speed-direct-shift.jpg',
          ...
          featureImagePath : this.carPath+'lexus-rx/features/lexus-safety-system.jpg',
          featureHeading: 'Lexus Safety System +',
          ...
          featureImagePath : this.carPath+'lexus-rx/features/360-degree-view-camera.jpg',
          featureHeading: '360-Degree View Camera (F Sport and Limited)',
          featureCopy: 'Remove the guess work with the 360-degree view camera, improving your driving experience and safety.',
        },{
          featureImagePath : this.carPath+'lexus-rx/features/touch-free-rear-power-door.jpg',
          ...
          featureImagePath : this.carPath+'lexus-rx/features/multimedia-display.jpg',
          ...
          featureImagePath : this.carPath+'lexus-rx/features/triple-beam-led-headlights.jpg',
          ...
          featureImagePath : this.carPath+'lexus-rx/features/warranty.jpg',
          featureHeading: 'Warranty',
          featureCopy: 'Refer to your Lexus Dealership.',
        }
      ]
      ...
      featureContent: [
        {
          featureImagePath : this.carPath+'lexus-lx/features/powerful-prestige.jpg',
          ...
          featureImagePath : this.carPath+'lexus-lx/features/v8-turbo-diesel.jpg',
          ...
          featureImagePath : this.carPath+'lexus-lx/features/fulltime-4wd.jpg',
          ...
          featureImagePath : this.carPath+'lexus-lx/features/lexus-safety-system.jpg',
          featureHeading: 'Lexus Safety System +',
          featureCopy: 'The package includes advanced driver assistance functions such as the Pre-Crash Safety system with Autonomous Emergency Braking, All Speed Dynamic Radar Cruise Control System, Lane-Keeping Assist and Automatic High Beam (Adaptive high beam for the Limited). The LX has all you need and more for a safe drive.',
        },{
          featureImagePath : this.carPath+'lexus-lx/features/advanced-off-road-capability.jpg',
          ...
          featureImagePath : this.carPath+'lexus-lx/features/multimedia-display.jpg',
          featureHeading: '12.3" Multimedia Display',
          featureCopy: 'Electro Multi Vision Display (EMV), a landscape-oriented 12.3" large-sized screen. The Thin Film Transistor (TFT) liquid-crystal EMV display has high-quality In-Plane-Switching and a hoodless design that gives the interior a sense of spaciousness.',
        },{
          featureImagePath : this.carPath+'lexus-lx/features/large-cargo-area.jpg',
          ...
          featureImagePath : this.carPath+'lexus-lx/features/cool-box.jpg',
          ...
          featureImagePath : this.carPath+'lexus-lx/features/active-height-control.jpg',
          ...
          featureImagePath : this.carPath+'lexus-lx/features/warranty.jpg',
          featureHeading: 'Warranty',
          featureCopy: 'Refer to your Lexus Dealership.',
        }
      ],
      ...
      featureContent: [
        {
          featureImagePath : this.carPath+'lexus-ct/features/compact-electric-hybrid-luxury.jpg',
          ...
          featureImagePath : this.carPath+'lexus-ct/features/ultra-low-emissions.jpg',
          ...
          featureImagePath : this.carPath+'lexus-ct/features/fuel-consumption.jpg',
          ...
          featureImagePath : this.carPath+'lexus-ct/features/drive-mode-select.jpg',
          featureHeading: 'Drive Mode Select',
          ...
          featureImagePath : this.carPath+'lexus-ct/features/dual-zone-climate-control.jpg',
          ...
          featureImagePath : this.carPath+'lexus-ct/features/seating.jpg',
          ...
          featureImagePath : this.carPath+'lexus-ct/features/warranty.jpg',
          featureHeading: 'Warranty',
          featureCopy: 'Refer to your Lexus Dealership.',
        }
      ]
